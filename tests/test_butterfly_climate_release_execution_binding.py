...
def test_independent_climate_release_execution_binding_matches_frozen_contract():
    ...
    assert panel["species_count"] == binding["independent_panel"]["species_count"] == 32
    assert panel["species_sha256"] == binding["independent_panel"]["species_sha256"]
    assert panel["species_sha256"] == (
