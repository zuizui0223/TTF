...
- total genetic transfer as a descriptive output without a p-value or significance label; retain all frozen evaluation species and report an unavailable aggregate if any total score is non-finite;
