...
PHASE4_CODE_PATHS = (
    ...
    "docs/supporting/genetic_phylogatr_confirmatory_protocol_v0.1.json",
    "docs/supporting/genetic_phylogatr_phase1_parser_rule_v0.1.json",
    "docs/supporting/genetic_phylogatr_phase1_digest_rule_v0.1.json",
    "docs/supporting/genetic_phylogatr_phase1_execution_rule_v0.1.json",
    "benchmarks/frozen/genetic_decker_species_exclusion_v0.1.json",
