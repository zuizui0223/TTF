...
def main() -> int:
    ...
    try:
        ...
        failure_status = (
            ...
            else "NOT_EVALUABLE_B_CHARACTER_MASK_OR_SURVIVOR_GEOMETRY"
        )
        payload = {
            ...
            "gates": {
                ...
                "relational_power_wilson95_lower_min": float(gate["relational_power_wilson95_lower_min"]),
                "private_type1_pass": False,
                "relational_power_pass": False,
                "overall_pass": False,
