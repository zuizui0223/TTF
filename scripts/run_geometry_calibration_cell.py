...
from ttf.calibration import run_geometry_calibration, seed_for
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Run one frozen TTF Gate-I empirical-geometry calibration cell."
    )
    ...
    payload = {
        "schema": "ttf_gate_i_geometry_cell_v0.1",
        "geometry": {
